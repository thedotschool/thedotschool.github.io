...
const Scholarship = () => {
  ...
  return (
    <section id="scholarship" className="py-20 md:py-28 bg-background relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-secondary/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "-3s" }} />
      ...
      <div className="container relative z-10" ref={sectionRef}>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div 
              className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/15 text-accent-foreground text-sm font-medium mb-6 transition-all duration-500 ${
          ...
          <div 
            className={`relative transition-all duration-700 ${
              isInView ? "opacity-100 translate-x-0 rotate-0" : "opacity-0 translate-x-8 rotate-3"
            }`}
            style={{ transitionDelay: "300ms" }}
          >
            <div className="bg-primary rounded-3xl p-8 md:p-10 shadow-elevated pattern-african group hover:shadow-[0_30px_60px_-15px_hsl(235_50%_25%/0.4)] transition-all duration-500">
              <div className="text-center">
                <GraduationCap className="w-16 h-16 text-accent mx-auto mb-6 group-hover:scale-110 transition-transform duration-300" />
                ...
                <div className="bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm group-hover:bg-primary-foreground/15 transition-colors duration-300">
            ...
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-accent/20 rounded-2xl blur-xl animate-float" />
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-secondary/20 rounded-2xl blur-xl animate-float" style={{ animationDelay: "-2s" }} />
          </div>
        </div>
      </div>
    </section>
